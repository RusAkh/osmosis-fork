...
import (
	...
	types1 "github.com/osmosis-labs/osmosis/v12/x/lockup/types"
...
type QueryTotalDelegationByValidatorForDenomResponse struct {
	AssetResponse []Delegations `protobuf:"bytes,1,rep,name=asset_response,json=assetResponse,proto3" json:"asset_response"`
}
...
func (m *QueryTotalDelegationByValidatorForDenomResponse) GetAssetResponse() []Delegations {
	if m != nil {
...
type Delegations struct {
	...
	AmountSfsd     github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,2,opt,name=amount_sfsd,json=amountSfsd,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"amount_sfsd"`
	OsmoEquivalent github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,3,opt,name=osmo_equivalent,json=osmoEquivalent,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"osmo_equivalent"`
}
...
var fileDescriptor_e3d9448e4ed3943f = []byte{
	...
	,
}
...
func (m *QueryTotalDelegationByValidatorForDenomResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AssetResponse) > 0 {
		for iNdEx := len(m.AssetResponse) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AssetResponse[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryTotalDelegationByValidatorForDenomResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AssetResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AssetResponse = append(m.AssetResponse, Delegations{})
			if err := m.AssetResponse[len(m.AssetResponse)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
